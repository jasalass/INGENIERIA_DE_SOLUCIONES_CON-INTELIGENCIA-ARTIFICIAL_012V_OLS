...
class DocumentContextTests(unittest.TestCase):
    ...
    def test_prompt_receives_origin_relation_and_literal_parent(self):
        ...
        self.assertEqual(context[0]["documento_origen"], "21.719")
        self.assertEqual(context[0]["ley_referenciada"], "19.628")
        self.assertEqual(context[0]["nivel1"], "primero")
        self.assertEqual(context[-1]["texto"], self.backend.document_context.texto)
