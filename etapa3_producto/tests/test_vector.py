...
class VectorTests(unittest.TestCase):
    ...
    def test_sql_parameterization_null_and_exact_ranking(self):
        ...
        # Ya no se fuerza "SET LOCAL enable_indexscan = off" -- apagaba
        # tambien los indices btree de metadatos, no solo el ivfflat (ver
        # sql/001_schema.sql). El ranking exacto ahora se logra no creando
        # el indice aproximado, asi que la unica sentencia ejecutada es el
        # SELECT parametrizado de mas arriba.
