...
# Primero el .env compartido del proyecto integrado (Etapa 2 + 3, en la
# raiz del repo); despues el fallback de busqueda hacia arriba desde el
# directorio actual, por si alguien sigue usando Etapa 2 de forma
# standalone con su propio etapa2_rag/.env (load_dotenv no pisa una
# variable ya cargada, asi que el .env de la raiz manda si ambos existen).
