...
def _post_embeddings(texts: list[str]) -> list[list[float]]:
    ...
    if MISTRAL_BASE_URL.rstrip("/") != "https://api.mistral.ai/v1" or MISTRAL_EMBED_MODEL != "mistral-embed":
        raise ValueError("Este índice requiere el endpoint oficial y mistral-embed")
